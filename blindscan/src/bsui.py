...
from . import _
from enigma import eComponentScan, eDVBFrontendParametersSatellite, eDVBSatelliteEquipmentControl
...
from .bsverify import verifyDebug


class BlindscanUIMixin(object):
