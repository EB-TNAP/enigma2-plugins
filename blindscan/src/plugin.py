...
from .bsverify import BlindscanVerifyMixin, verifyDebug, verifyDebugException
...
class Blindscan(BlindscanVerifyMixin, BlindscanResultsMixin, ConfigListScreen, Screen, TransponderFiltering):
	skin = """
